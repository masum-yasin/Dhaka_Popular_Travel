  ...
  return (
    <>
      ...
      <nav className="bg-gray-900">
        ...
        <a href='https://populartravel.com.bd/about-us.html' className="btn btn-ghost text-xl"> <img className="items-center mt-3" src={travel} alt="" /></a>
       ...
       <div className="text-neutral-100 text-xl"><PiBellRingingBold /></div>
